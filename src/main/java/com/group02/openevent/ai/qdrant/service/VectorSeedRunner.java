 ...
 * COMMENTED OUT - to prevent errors when embedding service is not available
 */
// @Component - Commented out to prevent errors when embedding service is not available
