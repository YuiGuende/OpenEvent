...
// ================== Đếm ký tự Summary ==================
document.getElementById('eventSummaryInput')
...
// ================== Lineup ==================
document.getElementById('addLineupBtn')
...
function addLineupSection() {
    ...
    div.querySelector('.lineup-upload-overlay').onclick = (e) => { e.stopPropagation(); triggerUpload(); };
    div.querySelector('.lineup-upload-btn').onclick = (e) => { e.preventDefault(); triggerUpload(); };
